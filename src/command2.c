...
/*
    if(!strcmp(str,"ㄴㅅ") || !strcmp(str,"ㅅㄴ") || !strcmp(str,"24") || !strcmp(str,"42") || !strcmp(str,"서남"))
        ...
        strcpy(tempstr, "북동");
         ...
         if(str[0]=='2' || !strcmp(str,"ㄴ")) strcpy(tempstr, "남");
    else if(str[0]=='4' || !strcmp(str,"ㅅ")) strcpy(tempstr, "서");
    else if(str[0]=='6' || !strcmp(str,"ㄷ")) strcpy(tempstr, "동");
    else if(str[0]=='8' || !strcmp(str,"ㅂ")) strcpy(tempstr, "북");
    else if(str[0]=='3' || !strcmp(str,"ㅁ")) strcpy(tempstr, "밑");
    else if(str[0]=='9' || !strcmp(str,"ㅇ")) strcpy(tempstr, "위");
